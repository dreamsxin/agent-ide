...
2026-09-07 first real Linux CI results (user-reported, 196 passed / 4 failed): the Linux job again earned its keep — it found one genuine cross-platform product bug plus three tests that were only ever true on Windows.
