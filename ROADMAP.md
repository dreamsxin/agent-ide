...
2026-09-07 headless reproduction of a desktop failure, and what it found instead (`cargo clippy --all-targets -- -D warnings` clean; **`cargo test` deliberately not run** — see the test-isolation warning below).
