...
2026-09-07 in-process local inference removed (`cargo clippy --all-targets -- -D warnings` clean and `cargo test` 205 passed / 0 failed / 1 ignored, both now with **default features**, i.e. exactly what a contributor gets):
